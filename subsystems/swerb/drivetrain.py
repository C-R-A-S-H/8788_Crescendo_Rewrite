...
import swerve_utils
from swerb_module import MAXSwerveModule
...
class DriveSubsystem(Subsystem):
    def __init__(self) -> None:
        ...
        self.frontLeft = MAXSwerveModule(
            ...
            DriveConstants.TurnEncoderFrontLeft,
        ...
        self.frontRight = MAXSwerveModule(
            ...
            DriveConstants.TurnEncoderFrontRight,
        ...
        self.rearLeft = MAXSwerveModule(
            ...
            DriveConstants.TurnEncoderBackLeft,
        ...
        self.rearRight = MAXSwerveModule(
            ...
            DriveConstants.TurnEncoderBackRight,
    ...
    def drive(
        ...
        if rateLimit:
            ...
            angleDif = swerve_utils.angleDifference(
                inputTranslationDir, self.currentTranslationDir
            )
            if angleDif < 0.45 * math.pi:
                self.currentTranslationDir = swerve_utils.stepTowardsCircular(
                ...
                if self.currentTranslationMag > 1e-4:
                    ...
                    self.currentTranslationDir = swerve_utils.wrapAngle(
