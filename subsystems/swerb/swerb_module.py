...
class MAXSwerveModule:
    def __init__(
        self, drivingCANId: int, turningCANId: int, turningEncoderCAN:int, chassisAngularOffset: float
    ) -> None:
        ...
        self.turningEncoder = phoenix6.hardware.CANcoder(turningEncoderCAN,"rio")
       ...
       #TODO make sure turning encoders are reversed
        ...
        self.desiredState.angle = Rotation2d(self.turningEncoder.get_position().value_as_double)
    ...
    def getState(self) -> SwerveModuleState:
        ...
        return SwerveModuleState(
            ...
            Rotation2d(self.turningEncoder.get_position().value_as_double - self.chassisAngularOffset),
        )
    ...
    def setDesiredState(self, desiredState: SwerveModuleState) -> None:
        ...
        optimizedDesiredState = SwerveModuleState.optimize(
            correctedDesiredState, Rotation2d(self.turningEncoder.get_position().value_as_double)
        )
